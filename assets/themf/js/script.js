...
$('#styleSelector').append('' +
	...
	$('body').append('' +
        ...
        '<a href="https://1.envato.market/c/1289604/275988/4415?subId1=phoenixcoded-item-pages&u=https%3A%2F%2Fthemeforest.net%2Fitem%2Fable-pro-responsive-bootstrap-4-admin-template%2F19300403" target="_blank" class="btn btn-md btn-buy" onClick="gtag(\'event\', \'click\', {\'event_category\': \'buynow\',\'event_label\': \'buy-now\',\'value\': 1 });" >' +
        '<i class="fa fa-shopping-cart" aria-hidden="true"></i> Buy Able pro On Themeforest' +
        '</a> ' +
        '</div>' +
    '');
	var $window = $(window);
